          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <div className="flex justify-center mb-4 animate-fade-in">
              <img
                ...
                className="h-64 md:h-56 w-auto"
              />
            </div>

            {/* Tagline */}
            <h1 className="md:text-3xl animate-slide-up !font-bold !text-4xl text-[#F5C842]">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row items-center justify-center animate-slide-up-delay-3 !mt-[5px] !mb-[25px] !pt-[24px] !gap-[16px]">
              <Link
                to="/contact"
